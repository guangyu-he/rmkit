                ...
                onTriggered: {
                    ...
                    xhr.onreadystatechange = function() {
                        ...
                        for (var j = 0; j < chars.length; j++) {
                            var ch = chars[j]
                            if (ch === "\b") {
                                // hook 拦截到的退格（backup，万一有的键盘走 setCommitString）
                                ...
                                pinyinIME.pinyinBuffer += ch  // 保留原始大小写
                                changed = true
                                if (wasEmpty) {
                                    pinyinIME.setMode("pinyin_active", true)
                                    // 插入零宽空格占位符，退格将吃它而不是正文
                    ...
                    xhr.open("GET", "http://127.0.0.1:19876/pop-all-chars")
                    xhr.send()
                }
            }
                        ...
                        Row {
                            ...
                            Repeater {
                                ...
                                delegate: Item {
                                    ...
                                    Text {
                                        ...
                                        anchors.centerIn: parent
                                        text: (index + 1) + "." + pinyinIME.candidates[parent.globalIdx]
                                        color: cTap2.pressed ? "#aaaaaa" : "white"
                                        font.pixelSize: 28
                                    }
                                    MouseArea {
                                        id: cTap2
                            ...
                            Item {
                                ...
                                Text {
                                    ...
                                    text: "‹"
                                    font.pixelSize: 28
                                    color: pinyinIME.pageIdx > 0 ? (prevTap2.pressed ? "#aaaaaa" : "white") : "#555555"
                                }
                                MouseArea {
                                    id: prevTap2
                                    anchors.fill: parent
                            ...
                            Item {
                                ...
                                Text {
                                    ...
                                    text: "›"
                                    font.pixelSize: 28
                                    color: pinyinIME.pageIdx < pinyinIME.pageCount - 1 ? (nextTap2.pressed ? "#aaaaaa" : "white") : "#555555"
                                }
                                MouseArea {
                                    id: nextTap2
                                    anchors.fill: parent
